...
class GorInterface {
    ...
    async main() {
        ...
        const methods = proto.GordMessage.type.field
        ...
        program
            ...
            .description(`Gor gRPC client ${pkg.version}`)
...
Please run ${'gor-rpc help'.yellow} for addition information and examples.        
        `)
        ...
        program
            ...
            .action(async (cmd, options) => {
                ...
                console.log('');
                console.log(`Gor gRPC client ${pkg.version}`);
                console.log('');
...
Examples:
    ...
    $ ${`rpc --verbose getUtxosByAddresses --addresses=[\\"gortest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u\\"]`.yellow}
    ...
    Where file.js can contain: ${`{ addresses : ['gortest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u'] }`.yellow}
